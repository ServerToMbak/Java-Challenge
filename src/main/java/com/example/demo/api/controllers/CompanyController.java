...
public class CompanyController {
	...
	public ResponseEntity<DataResult<Company>> getById(int companyId)
	{
	...
	public ResponseEntity<Result> delete(@RequestBody Company company){
		return ResponseEntity.ok(this.companyService.Delete(company));
	}
	@PutMapping("/update")
	public ResponseEntity<Result> update(@RequestBody Company company){
